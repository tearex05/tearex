  ...
  return (
    ...
    <div id="skills" className={`w-screen min-h-screen flex flex-col items-center justify-center text-center text-white mt-80 text-5xl font-bold pb-4`}>
      ...
      <div className="mt-20 w-screen min-h-screen text-white flex flex-col items-center">
        ...
        <h1 data-aos="fade-left" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill2})`}}>MongoDb</h1>
        <h1 data-aos="fade-right" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill3})`}}>NodeJs</h1>
        <h1 data-aos="fade-left" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill4})`}}>Express</h1>
        <h1 data-aos="fade-right" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill5})`}}>Javascript</h1>
        <h1 data-aos="fade-left" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill6})`}}>Python</h1>
        <h1 data-aos="fade-right" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill7})`}}>Tailwind</h1>
        <h1 data-aos="fade-left" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill8})`}}>Git & Github</h1>
        <h1 data-aos="fade-left" loading="lazy" className="w-9/12 rounded-3xl flex items-center justify-center font-normal text-5xl sm:text-6xl md:text-7xl text-center px-5 py-10 cursor-pointer mb-20" style={{backgroundImage: `url(${skill9})`}}>Html & Css</h1>
      </div>
    </div>
