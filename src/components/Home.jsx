...
function Home() {
	...
	return (
		<div className="w-screen h-screen flex flex-col items-center justify-center text-center" id="home">
			...
			<h1 className="text-white text-md sm:text-xl md:text-2xl lg:text-3xl">You don't find the happy life<br /><span className="font-black text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-white">You Make It</span></h1>
			</div>
		</div>
	)
}
